...
<div class="container">
    ...
    <hr/>
    <h3>所有博客 <a href="/admin/blogs/addPage" type="button" class="btn btn-primary btn-sm">添加</a></h3>
    <!-- 如果用户列表为空 -->
    <c:if test="${empty blogList}">
        <div class="alert alert-warning" role="alert">
            <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>Blog表为空，请<a
                href="/admin/blogs/addPage"
                type="button"
            ...
            <c:forEach items="${blogList}" var="blog">
                <tr>
                    ...
                    <td>
                        ...
                        <a id="/admin/blogs/delete/${blog.id}" type="button" class="btn btn-sm btn-danger"
                           onclick="deleteBlog(this)">删除</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
